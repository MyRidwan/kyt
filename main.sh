...
green='\e[0;32m'
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  ${BLUE}Welcome To RidWan Project Script Installer ${NC}${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e "     ${BLUE}This Will Quick Setup VPN Server On Your Server${NC}"
echo -e "         ${RED}Auther : ${NC}${BLUE}RidWan ${NC}${YELLOW}(${NC} ${green}Geo Project ${NC}${YELLOW})${NC}"
echo -e "      ${RED} © Recode By Geo Project ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
