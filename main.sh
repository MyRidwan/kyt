...
green='\e[0;32m'
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  ${green}Welcome To RidWan Project Script Installer ${NC}${YELLOW}(${NC} Stable Edition ${YELLOW})${NC}"
echo -e "     ${green}This Will Quick Setup VPN Server On Your Server${NC}"
echo -e "         ${green}Auther : RidWan ${NC}${YELLOW}(${NC} Kyt Project ${YELLOW})${NC}"
echo -e "      ${green} © Recode By Geo Project & Ridwan${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
