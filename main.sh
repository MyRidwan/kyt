...
green='\e[0;32m'
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  ${green}Welcome To RidWan Project Script Installer ${NC}${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e "     ${green}This Will Quick Setup VPN Server On Your Server${NC}"
echo -e "         ${green}Auther : ${NC}${red}RidWan ${NC}${YELLOW}(${NC} ${red}Geo Project ${NC}${YELLOW})${NC}"
echo -e "      ${RED} © Recode By Geo Project & Ridwan${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
